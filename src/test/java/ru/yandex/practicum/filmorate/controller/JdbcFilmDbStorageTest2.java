...
class JdbcFilmDbStorageTest2 {
    ...
    void getRecommendations() {
        userDbStorage.create(User.builder()
                ...
                .birthday(LocalDate.of(1984, 10, 17))
                .build());
        ...
        filmDbStorage.create(Film.builder().id(3L).name("Бегущий по лезвию").description("Драма США").duration(164)
                .releaseDate(LocalDate.of(1985,9,16)).mpa(new Mpa(2, "Драма")).build());
        ...
        //List<Film> filmsAnd = filmDbStorage.getFilmsSortedByLikesAnd(1,"Комедия","1985");
       // System.out.println(filmsAnd);
    }
    ...
    void getFilms() {
        ...
        /*filmDbStorage.getFilms();
        System.out.println(filmDbStorage.getFilms());
        List<Film> filmsAnd = filmDbStorage.getCommonFilms(11L, 12L);
        System.out.println(filmsAnd);
        System.out.println("-");
        System.out.println("-");
        System.out.println("-");
        ...
        //List<Film> filmsAnd2 = filmDbStorage.getFilmsSortedByLikesAnd2(1, 1,"1985");
        //System.out.println(filmsAnd2);
    }
}
